...
<body>
	...
	<div id="mainmenu" class="leftcolumn">
			...
			<a class="bar-item" style="font-size:15pt; background-color:rgba(61, 139, 173, 0.8);">TOP 20</a>
	...
	<div id="itemcondition" class="content">
		...
		<br></br>
		<!--標題-->
		<div style="text-align:center; font-family:Hastoler;"><font size="7"><strong> ~ ~ ~ TOP 20 ~ ~ ~ </strong></div>
		<br></br>
	...
	<?php
		...
		$sql=sprintf("select * from clothes
						ORDER BY sold DESC
						LIMIT 0, 20");
