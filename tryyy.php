...
<body>
	...
	<div id="intro" class="modal fade">
		<div class="w3-modal-content w3-animate-zoom">
			...
			<div class="w3-container">
				<h3><div id="inven" style="font-family:SetoFont"></div></h3>
			</div>
			<div class="w3-container w3-black">
				<h1><div style="font-family:SetoFont">商品尺寸</div></h1>
			</div>
			<div class="w3-container">
				<h3><div id="si" style="font-family:SetoFont"></div></h3>
			</div>
			<div class="w3-container w3-black">
				<h1><div style="font-family:SetoFont">商品價錢</div></h1>
			</div>
			<div class="w3-container">
				<h3><div id="money" style="font-family:SetoFont"></div></h3>
			</div>
		</div>
	</div>
